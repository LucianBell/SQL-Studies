...
SELECT first_name, last_name, birth_date, ((current_date) - birth_date)/ 365
FROM sales.customers

-- (Exemplo 2) Utilização da coluna calculada nas queries
-- Liste os 10 clientes mais novos da tabela customers
SELECT first_name, last_name, birth_date, ((current_date) - birth_date)/ 365 as "Age"
FROM sales.customers
ORDER BY "Age"
LIMIT 10
-- Ao declarar um alias para uma coluna (as) devemos usar aspas duplas
